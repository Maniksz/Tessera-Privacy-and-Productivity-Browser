...
export const de = {
  ...
  'site.permission.allowed': '{topic}: Erlaubt',
  'site.permission.blocked': '{topic}: Blockiert',
  'site.permission.forget': 'Vergessen',
  'site.permissions.forgetAll': 'Alle Berechtigungen dieser Seite vergessen ({count})',
  'site.permissions.none': 'Keine gespeicherten Berechtigungen für diese Seite',
  'site.permissions.private': 'In privaten Fenstern werden keine Berechtigungen gespeichert',
  'site.topic.geolocation': 'Standort',
  'site.topic.notifications': 'Benachrichtigungen',
  'site.topic.clipboardRead': 'Zwischenablage lesen',
  'site.topic.clipboardWrite': 'In die Zwischenablage schreiben',
  'site.topic.midi': 'MIDI-Geräte',
  'site.topic.midiSysex': 'Befehle an MIDI-Geräte',
  'site.topic.storageAccess': 'Speicher über Seiten hinweg',
  'site.topic.topLevelStorageAccess': 'Speicher über Seiten hinweg (ganze Seite)',
  'site.zoom': 'Zoom: {percent} %',
  'site.fingerprint': 'Fingerprint-Schutz',
  'site.fingerprint.newTabs': 'Gilt für Tabs, die nach einer Änderung geöffnet werden',
