...
export const en = {
  ...
  */
  ...
  'tab.splitEntry': 'Tiled view: {titles}',
  'tab.splitEntryActive': '{title} (active tile)',
  'tab.splitEntryMute': 'Mute tiled view',
  'tab.splitEntryUnmute': 'Unmute tiled view',
  'tab.splitEntryClose': 'Close all tabs in tiled view',
  // the tab search (U22)
