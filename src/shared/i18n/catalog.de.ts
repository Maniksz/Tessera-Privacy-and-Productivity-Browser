...
export const de = {
  ...
  'workspaces.saveAs': 'Speichern als…',
  'workspaces.name': 'Name des Workspace',
  'workspaces.replace': '„{name}“ ersetzen?',
  'workspaces.readOnly': 'Von einer neueren Version: nur lesbar.',
  'workspaces.remove': '{name} entfernen',
  ...
  'omnibox.suggestions': 'Vorschläge',
  'omnibox.switchToTab': 'Zu diesem Tab wechseln',
  ...
  'tab.splitEntry': 'Kachelansicht: {titles}',
  'tab.splitEntryActive': '{title} (aktive Kachel)',
  'tab.splitEntryMute': 'Kachelansicht stummschalten',
  'tab.splitEntryUnmute': 'Stummschaltung der Kachelansicht aufheben',
  'tab.splitEntryClose': 'Alle Tabs der Kachelansicht schließen',
  'tabsearch.title': 'Tabs durchsuchen',
  'tabsearch.placeholder': 'Titel oder Adresse',
  'tabsearch.empty': 'Kein Tab passt',
  'tabsearch.close': 'Tab-Suche schließen',
  ...
  'autofill.suggest.disabled':
    'Das Ausfüllen von Passwörtern ist in den Einstellungen ausgeschaltet.',
  ...
  'autofill.refusal.differentSite':
    'Das ist nicht die Seite, für die das Passwort gespeichert wurde.',
  ...
  'backup.repeat': 'Passphrase wiederholen',
  'backup.hint':
    'Mindestens 12 Zeichen. Eine vergessene Passphrase lässt sich nicht wiederherstellen, das Backup dann auch nicht.',
  'backup.mismatch': 'Die beiden Passphrasen unterscheiden sich.',
  'backup.create': 'Backup anlegen…',
  'backup.saved': 'Backup gespeichert.',
  'backup.vaultIncluded': 'Der Passwort-Tresor kommt mit und bleibt hinter seinem Master-Passwort.',
  'backup.vaultNoMasterPassword': 'Ohne Master-Passwort bleibt der Passwort-Tresor draußen.',
  'backup.vaultUnreadable': 'Der Passwort-Tresor lässt sich gerade nicht lesen und bleibt draußen.',
  'backup.restore': 'Wiederherstellen…',
  'backup.restorePassphrase': 'Passphrase des Backups',
  'backup.from': 'Backup vom {date}, Version {version}',
  'backup.userRules': 'Eigene Filterregeln',
  'backup.confirm':
    'Was angehakt ist, wird beim nächsten Start eingespielt, nach einer Sicherungskopie der aktuellen Daten. Berechtigungen, Filterregeln und Sicherheitseinstellungen bleiben, wie sie sind, solange sie nicht angehakt sind.',
  'backup.securitySettings': 'Abweichende Sicherheitseinstellungen',
  'backup.stage': 'Beim nächsten Start einspielen',
  'backup.staged': 'Die Wiederherstellung läuft beim nächsten Start.',
  'backup.pending': 'Eine Wiederherstellung wartet auf den nächsten Start.',
  'backup.notABackup': 'Das ist kein {app}-Backup.',
  'backup.tooLarge': 'Diese Datei ist zu groß für ein Backup.',
  'backup.wrongPassphrase': 'Falsche Passphrase oder beschädigte Datei.',
  'backup.newer':
